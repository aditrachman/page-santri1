            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                <div>
                  <a
                    href="#"
                    className="inline-flex items-center text-white bg-gray-900 rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-600"
                  >
                  ...
                  <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-gray-800 sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                    <span className="md:block">Mari bergabung bersama</span>{' '}
                    <span className="text-indigo-600 md:block">Santri Hub</span>
                  </h1>
              ...
              <div className="mt-16 sm:mt-24 lg:mt-0 lg:col-span-6">
                <div className="border-solid border-2 border-sky-500 sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden">
